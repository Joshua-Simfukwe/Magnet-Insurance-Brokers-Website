                        ...
                        <nav role="navigation" class="uui-navbar08_menu-2 w-nav-menu">
                            ...
                            <div class="uui-navbar08_menu-right-2">
                                <div class="uui-navbar08_button-wrapper-2"><a id="Main-link-login" href="employees.html"
                                        target="_blank" class="button-primary outline w-button">Login</a><a id="Main-link-contact"
                                        href="contact.html" class="button-primary w-button">Contact us</a>
                                </div>
                            </div>
                        </nav>
            ...
            <section class="footer-subscribe">
                <div class="container footer">
                    ...
                    <div class="footer-wrapper-three">
                        <div class="footer-block-three"><a id="About-footer-link" href="about-us.html" aria-current="page"
                                class="footer-link-three w--current">About us</a><a id="Partners-footer-link" href="partners.html"
                                class="footer-link-three">Partners</a><a id="contact-footer-link" href="contact.html"
